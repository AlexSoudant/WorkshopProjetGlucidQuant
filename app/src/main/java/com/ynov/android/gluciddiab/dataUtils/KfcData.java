...
public class KfcData {
    public static void insertFastFoodData(SQLiteDatabase db){
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbuckettenders");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbuckethotwings");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbucketmixtendershotwings");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbucketmixorhot");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcmaxibuckettenders");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcmaxibuckethotwings");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbigbucketmixtendershotwings");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 31);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbigbucketmixorhot");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfckrunchy");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfctwistertenders");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbossbacon");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbrazer");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 5);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcitwist");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 7);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcsaladecaesar");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 3);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcsaladechevrenoix");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 10);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfctenders");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcwingshot");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcpiecespouletor");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcpiecehot");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 1);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfctomatescerises");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 22);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 4);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfccobette");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcbigshots");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 16);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 2);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcdipncrunch");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfccookie");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcsundaess");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcptityaourtfraise");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcandrospocket");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcsundae");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 6);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 23);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcsundaefraise");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcmoelleuxchocolat");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfctiramisu");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcmuffin");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 11);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 11);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcptitflan");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 22);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 30);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfckreamballfraise");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfckreamballchocolat");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfckreamballcaramel");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 13);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcheineken");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcsevenup");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 0);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 25);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcorangina");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfclipton");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 0);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 23);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcoasis");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcpepsi");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 0);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcpepsimax");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 0);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcvittel");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 0);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 0);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfcperrier");
        list.add(cv);
        ...
        cv.put(KfcContract.KFCListEntry.GLU_LENT, 0);
        cv.put(KfcContract.KFCListEntry.GLU_RAPIDE, 25);
        cv.put(KfcContract.KFCListEntry.IMAGE_NAME, "kfctropicana");
        list.add(cv);
